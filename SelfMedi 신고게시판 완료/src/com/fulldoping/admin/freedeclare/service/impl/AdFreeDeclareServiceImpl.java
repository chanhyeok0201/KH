...
public class AdFreeDeclareServiceImpl implements AdFreeDeclareService{
	...
	public void delete(FreeDeclare freeDeclare) {
		...
		System.out.println("RRRRRRRRRRRRRRRRRR " + adFreeDeclareDao.deleteFile(conn, freeDeclare));
		...
		System.out.println("ttttttttttttttttttttttt " + adFreeDeclareDao.delete(conn, freeDeclare));
		...
		System.out.println("qqqqqqqqqqqqqqqqqqqqqqqqqq " +adFreeDeclareDao.deletefree(conn, freeDeclare));
